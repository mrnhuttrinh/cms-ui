...
const FirstPageLink = ({isActive, onClick}) => (
  <FlatButton labelPosition="after" label="FIRST" style={flatButtonStyle} icon={<NavigationFirstPage/>} onClick={onClick}/>
);

const PreviousPageLink = ({isActive, onClick}) => (
  <FlatButton labelPosition="after" label="PRVE" style={flatButtonStyle} icon={<NavigationChevronLeft/>} onClick={onClick}/>
);

const NextPageLink = ({isActive, onClick}) => (
  <FlatButton labelPosition="before" label="NEXT" style={flatButtonStyle} icon={<NavigationChevronRight/>} onClick={onClick}/>
);

const LastPageLink = ({isActive, onClick}) => (
  <FlatButton labelPosition="before" label="LAST" style={flatButtonStyle} icon={<NavigationLastPage/>} onClick={onClick}/>
);
